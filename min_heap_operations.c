...
// {
//     t_coder tmp;
//     t_coder *pushable_coder;
//     if(pushable && m_heap->size > 0)
//         pushable_coder = m_heap->queue;
//     else
//         pushable_coder = NULL;
...
//         if (pushable_coder)
//         {
//             m_heap->queue[m_heap->size] = *pushable_coder;
//             m_heap->queue[m_heap->size].priorety = m_heap->queue[m_heap->size-1].priorety + 1;
//             m_heap->size++;
//         }
//     }
// }   
